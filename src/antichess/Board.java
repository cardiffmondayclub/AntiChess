...
public class Board extends Frame {
    ...
    private BufferedImage wTile = null;
    private BufferedImage bTile = null;
    ...
    // MA - this paint method draws the board in a frame and uses the getImage method to show
    // where each piece is on the board as an image
    @Override
